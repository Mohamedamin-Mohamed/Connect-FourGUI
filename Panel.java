 ...
 */
 public class Panel{
	...
	Panel(JButton[][] buttons){ //we'll use the panel as out board, which will have 6 rows & 7 columns
   ...
   for(int i = 0; i < buttons.length; i++) {
	...
	return panel; //the board will be returned, example is so as to be added to the frame
	}
}
